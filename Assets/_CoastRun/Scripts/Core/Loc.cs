...
namespace CoastRun
{
    ...
    public static class Loc
    {
        ...
        {
            // 챕터 제목
            { "ch.1", "모르는 얼굴" }, { "ch.2", "보드" }, { "ch.3", "사진 속 얼굴" }, { "ch.4", "물장구" },
            { "ch.5", "밥" }, { "ch.6", "태왁" }, { "ch.7", "언덕 위 집" }, { "ch.8", "우유 두 병" },
            { "ch.9", "첫눈" }, { "ch.10", "파란 머리띠" }, { "ch.11", "흰 셔츠" }, { "ch.12", "우리 기지" },
            { "ch.13", "태풍" }, { "ch.14", "리어카" }, { "ch.15", "스무 살 생일" }, { "ch.16", "Passing by" },
